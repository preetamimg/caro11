...
<main class="main-root">
   ...
   <section id="about" class="about_us pt-0">
      <div class="container zi-9 position-relative">
         ...
         <div class="row zi-9 position-relative">
            <div class="col-md-4 d-flex align-items-stretch mb-lg-5 mb-md-4 mb-4">
               <div class="about_box">
                  <span class="">
            ...
            <div class="col-md-12 text-center">
               <a class="comman_button shadow ms-0" href="javascript:;">Read More<i class="far fa-arrow-right ms-2"></i></a>
            </div>
         </div>
      </div>
   </section>

   <section id="how-to-play" class="how_to_play bg-light">
      <div class="container">
         <div class="section_title text-center">
            <h2>How To Play</h2>
         </div>
         <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-12 col-12 ">
               <div class="row">
                  <div class="col-md-12 border-right-style">
                     <div class="row">
                        <div class="col-sm-6 d-flex align-items-stretch">
                           <div class="feature-box border-style-right text-md-end text-center step-1">
                              <span>Step 01</span>
                        ...
                        <div class="col-sm-6 d-flex align-items-stretch">
                           <div class="feature-box text-md-start text-center step-2">
                              <span>Step 02</span>
                  ...
                  <div class="col-md-12">
                     <div class="row">
                        <div class="col-sm-6 d-flex align-items-stretch">
                           <div class="feature-box border-style-right text-md-end text-center step-3">
                              <span>Step 03</span>
   ...
   <section class="clients_testimonials">
      <div class="container">
         <div class="section_title text-center">
         ...
         <div class="row">
            <div class="col-md-12">
               <div class="owl-carousel owl-theme testimonial-slider square-indicator">
                  <div class="item">
                     <div class="single-testimonial-item bg--custom">
                        <div class="testimonial-author">
                           <img src="<?php echo SCRIPT_ROOT ?>assets/img/jitendrakumar.jpg" alt="author image">
                           <div class="testimonial-author-info">
                              <h5>Jitendra Kumar</h5>
                              <span class="h6">Bangalore</span>
                           </div>
                        </div>
                        <p>“Caro11 Is Unique, It Is Very Different From Other Fantasy Cricket Apps Because It Gives Me An Option To Play Different Fantasy Cricket Formats. I Am Specially Fond Of Playing It Against Not Only Cricket Aficionados But Also With My Childhood Buddies.”</p>
                  ...
                  <div class="item">
                     <div class="single-testimonial-item bg--custom">
                        <div class="testimonial-author">
                           <img src="<?php echo SCRIPT_ROOT ?>assets/img/ajaysharma2.jpg" alt="author image">
                           <div class="testimonial-author-info">
                              <h5>Ajay Sharma</h5>
                              <span class="h6">Bangalore</span>
                           </div>
                  ...
                  <div class="item">
                     <div class="single-testimonial-item bg--custom">
                        <div class="testimonial-author">
                           <img src="<?php echo SCRIPT_ROOT ?>assets/img/kuldeep.jpg" alt="author image">
                           <div class="testimonial-author-info">
                              <h5>Kuldeep Chouhan</h5>
                              <span class="h6">Bangalore</span>
                           </div>
                        </div>
                        <p>“Caro11 Is Unique, It Is Very Different From Other Fantasy Cricket Apps Because It Gives Me An Option To Play Different Fantasy Cricket Formats. I Am Specially Fond Of Playing It Against Not Only Cricket Aficionados But Also With My Childhood Buddies.”</p>
   ...
   <section id="faqs" class="faq_section bg-light">
      <div class="container">
         <div class="section_title text-center">
